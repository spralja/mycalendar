class Cell:
    ...
    def __init__(self, pos_y, height, background_color="#000000"):
        self.pos_y = pos_y
        self.height = height
...
class Calendar:
    def __init__(self):
        self.table = [
            [Cell(0, 480), Cell(0, 480), Cell(0, 480), Cell(0, 480), Cell(0, 480), Cell(0, 480), Cell(0, 480), ],
            [Cell(480, 0), Cell(480, 0), Cell(480, 0), Cell(480, 0), Cell(480, 0), Cell(480, 0), Cell(480, 0), ],
        ]
    ...
    def add_event(self, event):
        ...
        height = int(duration.total_seconds()/180)
